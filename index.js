...
exports.sendMail = functions.https.onRequest((req, res) => {
    cors(req, res, () => {
        ...
        */
        ...
        var message = "To whom it may concern, on behalf of our client " + user.uid+  ", under section 4.9 of Schedule 1 of Canada’s federal privacy legislation — The Personal Information Protection and Electronic Documents Act — I am requesting a copy of all personal information held to my person by your organization." 
        ...
        const mailOptions = {
            ...
            to: dest,
            subject:'Information Access Request',
            // email subject
            html: ("<p style='font-size: 16px;'>" + message  +" </p> <br />")
        };
